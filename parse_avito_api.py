...
ITEMS_PER_PAGE = 5  # Количество объявлений на странице

# ==== Настройки пагинации ====
MAX_PAGES = 3        # Максимальное количество страниц для парсинга (0 = все страницы)
    ...
    while True:
        try:
            ...
            if page == 1:
                ...
                print(f"🔄 Стратегия: Пагинация по {total_pages} страницам")
                print("="*80)
            ...
            # Проверяем, достигли ли естественного конца (только если нет ограничений)
            if MAX_PAGES == 0 and STOP_AFTER_PAGES == 0 and page >= total_pages:
                print(f"🏁 Достигнут естественный конец - обработана последняя страница {page}")
                break
