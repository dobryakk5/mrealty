...
REQUEST_DELAY = 5.0  # Измените на нужное значение (например: 2.0, 5.0)
...
FOOT_MIN = 15  # Время в пути до метро в минутах (например: 20)
...
#     '_yasc': 'l+enFWhk/wn8hhnoRMI7mcqYGo+P9A7+FioWyEh577mVW1Emt6v1KxFK+QnESw==',
# }
